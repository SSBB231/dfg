...
var table = new def_table.Table({
    component: 'DFG',
	name: schema.default +'."DFG::SPEDXEEFI"',
	default_fields: 'common',
	fields:{
	    id: new def_table.AutoField({
			name: 'ID',
			auto: schema.default +'."DFG::SPEDXEEFI::ID".nextval',
...
this.readSPEDXEefi = function(object) {
...
this.createSPEDXEefi = function(object) {
    var createOptions = {
        idSPED: object.idSPED || null,
...
this.updateSPEDXEefi = function(object, where) {
...
this.deleteSPEDXEefi = function(object) {
    if (typeof object === "number") {
